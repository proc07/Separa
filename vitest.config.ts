...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      "@separa/plugin/vite": path.resolve(__dirname, "packages/plugin/src/vite.ts"),
      "@separa/plugin/webpack": path.resolve(__dirname, "packages/plugin/src/webpack.ts"),
      "@separa/plugin/rspack": path.resolve(__dirname, "packages/plugin/src/rspack.ts"),
      "@separa/plugin/rollup": path.resolve(__dirname, "packages/plugin/src/rollup.ts"),
      "@separa/plugin/esbuild": path.resolve(__dirname, "packages/plugin/src/esbuild.ts"),
      "@separa/plugin": path.resolve(__dirname, "packages/plugin/src/index.ts"),
